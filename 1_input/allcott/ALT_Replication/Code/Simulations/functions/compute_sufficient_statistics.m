...
global EXTERNALS OUTPUT LABORELAST;
...
filename = [EXTERNALS '/Intermediate/Simulations/ConsumptionByIncome.csv'];
...
filename = [EXTERNALS '/Intermediate/Simulations/PriceElasticity_IncomeHet.csv'];
fileID = fopen(filename,'r');
formatSpec = '%f%f%f%f%[^\n\r]';
dataArray = textscan(fileID, formatSpec, inf, 'Delimiter', ',', 'HeaderLines', 1);
fclose(fileID);
