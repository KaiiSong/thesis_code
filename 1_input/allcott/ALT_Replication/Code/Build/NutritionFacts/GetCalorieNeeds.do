...
insheet using $Externals/Data/NutritionFacts/CalorieNeeds.csv, comma nonames clear
...
save $Externals/Intermediate/NutritionFacts/CalorieNeedsTemp.dta, replace
...
saveold $Externals/Intermediate/NutritionFacts/CalorieNeeds.dta, replace

append using $Externals/Intermediate/NutritionFacts/CalorieNeeds.dta, gen(Male)

merge m:1 AgeBracket Male using $Externals/Intermediate/NutritionFacts/CalorieNeedsTemp.dta, nogen keepusing(CalorieNeed)
drop AgeBracket
...
erase $Externals/Intermediate/NutritionFacts/CalorieNeedsTemp.dta
